...
export default function AnimatedDemoPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 md:p-8 overflow-visible font-sans relative w-full">

      <div className="relative w-full max-w-5xl flex items-center justify-center z-10 my-10">
        
        {/* Floating Element: Uptime */}
        <motion.div
          animate={{ y: [0, -15, 0] }}
          transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
          className="absolute right-0 md:-right-10 top-16 md:top-24 bg-[#1A2235] border border-white/5 shadow-2xl rounded-2xl px-6 py-4 flex items-center gap-4 text-white z-30"
        >
        ...
        <motion.div
          ...
          className="absolute left-0 md:-left-16 bottom-16 md:bottom-24 bg-[#1A2235] border border-white/5 shadow-2xl rounded-2xl p-5 flex items-center gap-4 text-white z-30"
        >
        ...
        >
          ...
          <div className="flex flex-col h-full border-t md:border-t-0 md:border-l border-slate-100 pt-6 md:pt-0 md:pl-8">
            ...
            <motion.div 
              ...
              className="bg-[#FAFAFB] rounded-3xl p-6 mt-auto border border-slate-50"
            >
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-6 text-[#5142E6] text-xs font-bold bg-white w-fit px-2 py-1.5 rounded-full shadow-sm">
